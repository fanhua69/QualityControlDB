================================================================================
    MICROSOFT 基础类库： QCDB 项目概述
===============================================================================

应用程序向导已为您创建了此 QCDB 应用程序。此应用程序
不仅介绍了使用 Microsoft 基础类的基本知识，
而且是编写应用程序的起点。

此文件包含组成 QCDB 应用程序的每个文件的内容摘要。
...
MainFrm.h, MainFrm.cpp
    ...
    CFHMainFrm 并控制所有的 MDI 框架功能。
res\Toolbar.bmp
    此位图文件用于创建工具栏的平铺图像。
    初始工具栏和状态栏在 CMainFrame 
    类中构造。 使用资源编辑器编辑此工具栏位图，并
    更新 QCDB.rc 中的 IDR_MAINFRAME TOOLBAR 数组以添加
    工具栏按钮。
/////////////////////////////////////////////////////////////////////////////
...
QCDBDoc.h、QCDBDoc.cpp - 文档
    这些文件包含 CQCDBDoc 类。  编辑这些文件
    以添加特殊的文档数据并实现文件的保存和加载
    （通过 CQCDBDoc::Serialize）。
QCDBView.h、QCDBView.cpp - 文档视图
    这些文件包含 CQCDBView 类。
    CQCDBView 对象用于查看 CQCDBDoc 对象。
res\QCDBDoc.ico
    这是一个图标文件，用作 
    CQCDBDoc 类 MDI 子窗口的图标。  此图标包含在主
    资源文件 QCDB.rc 中。
/////////////////////////////////////////////////////////////////////////////
...
StdAfx.h、StdAfx.cpp
    这些文件用于生成名为 QCDB.pch 的预编译头文件 (PCH)
