...
#define HID_VIEW_DATAFLOW                       0x10066
#define HID_editPassword                        0x103EC
#define HID_CreateNewJLDB                       0x17FBC
#define HID_DBTree_DrawData                     0x17FBD
#define HID_SetDBShowProperty                   0x17FBE
#define HID_DBTree_DrawChart                    0x17FBF
#define HID_UpdateDataFromDB                    0x17FC0
#define HID_DBLoadPicture                       0x17FC1
#define HID_ChooseShowData                      0x17FC2
#define HID_DBRecordShowProperty                0x17FC3
#define HID_CreateOriDB                         0x17FC4
#define HID_SendDataToServer                    0x17FC5
#define HID_DBEdit_Delete                       0x17FC6
#define HID_DBEdit_Update                       0x17FC7
#define HID_DBEdit_Addnew                       0x17FC8
#define HID_Linker_ShowAllChildren              0x17FC9
#define HID_Linker_ShowLinkingChildren          0x17FCA
#define HID_Linker_ShowAllParents               0x17FCB
#define HID_Linker_ShowLinkingParents           0x17FCC
#define HID_SetGlobalInfo                       0x17FCD
#define HID_SendDataToServerNoHanded            0x17FCE
#define HID_SendDataToServerAll                 0x17FCF
#define HID_NextPage                            0x17FD0
#define HID_PrevPage                            0x17FD1
#define HID_DBShowPrevPage                      0x17FD2
#define HID_DBShowNextPage                      0x17FD3
#define HID_Show_Data                           0x17FD4
#define HID_ReListen                            0x17FD5
#define HID_ChoosePage                          0x17FD6
#define HID_DeleteRecord                        0x17FD7
#define HID_AddRecord                           0x17FD8
#define HID_ModifyShowProperty                  0x17FD9
#define HID_RecoverRecord                       0x17FDA
#define HID_UpdateDB                            0x17FDC
#define HID_LoadPic                             0x17FDD
#define HID_SetPicProperty                      0x17FDE
#define HID_buttonSetPar                        0x17FDF
#define HID_buttonHistory                       0x17FE0
#define HID_ShowDataFlowHistory                 0x17FE1
#define HID_ShowLinker                          0x17FE2
#define HID_GetDataFromServer                   0x17FE3
#define HID_SetChartProperty                    0x17FE4
#define HID_VIEW_DATALINKER                     0x17FE7
#define HID_ShowHor                             0x17FE8
#define HID_OutputTable                         0x17FE9
#define HID_ZoomIn                              0x17FEA
#define HID_ZoomOut                             0x17FEB
#define HID_ZoomFull                            0x17FEC
#define HID_REPORTVIEW_SetShowProperty          0x17FED
#define HID_REPORTVIEW_Print                    0x17FEE
#define HID_DBBROWSE_InputQCData                0x17FEF
#define HID_VIEW_OUTPUTBAR                      0x18062
#define HID_VIEW_WORKSPACE                      0x18063
#define HID_ChooseDataBase                      0x18065
#define HID_MakeNewDataBase                     0x18067
#define HID_ConnectServers                      0x18068
#define HID_UserRegister                        0x1806E
#define HID_ClearDB                             0x18070
#define HID_DBBROWSE_32881                      0x18071
#define HID_CloneLastRecord                     0x18073
#define HID_WORKSPACEBAR                        0x19AB5
#define HID_OutputBar                           0x19AB7
...
// Resources (IDR_*) 
#define HIDR_MAINFRAME                          0x20068
#define HIDR_QCDBTYPE                           0x20069
#define HIDR_DBBrowser_ChooseData               0x2006C
#define HIDR_DBBrowse                           0x2006E
#define HIDR_Password                           0x2006F
#define HIDR_DBChart                            0x20070
#define HIDR_DBTree_Popup                       0x20072
#define HIDR_DataTransfer                       0x20074
#define HIDR_Menu_LinkerView                    0x20076
#define HIDR_DataReceiver                       0x20079
#define HIDR_Menu_DataBrowseView                0x2007B
#define HIDR_ID_Creator                         0x20080
#define HIDR_ReportCreator                      0x20085
#define HIDR_ReportView                         0x20087
 
// Dialogs (IDD_*) 
#define HIDD_ABOUTBOX                           0x20064
#define HIDD_DBShowProperty                     0x2006A
#define HIDD_ChooseRecords                      0x2006B
#define HIDD_RecordShowProperty                 0x2006D
#define HIDD_DBPicProperty                      0x2006F
#define HIDD_DlgGlobalProperty                  0x20071
#define HIDD_InputServers                       0x20075
#define HIDD_LocalPort                          0x20077
#define HIDD_DlgTranProperty                    0x20078
#define HIDD_ChoosePage                         0x2007C
#define HIDD_InterfaceProperty                  0x2007D
#define HIDD_DlgChartProperty                   0x2007E
#define HIDD_DlgGraphProperty                   0x2007F
#define HIDD_DlgPeojectProperty                 0x20081
#define HIDD_DlgUserInfo                        0x20082
#define HIDD_DlgReportProperty                  0x20083
#define HIDD_ChooseRecordsInd                   0x20084
#define HIDD_DlgReportShowProperty              0x20086
#define HIDD_DBSumField                         0x20088
